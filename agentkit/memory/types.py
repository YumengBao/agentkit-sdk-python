...
class NetworkConfigurationForListMemoryCollections(MemoryBaseModel):
    ...
    vpc_configuration: Optional[VpcConfigurationForListMemoryCollections] = Field(default=None, alias="VpcConfiguration")
...
class MemoriesForListMemoryCollections(MemoryBaseModel):
    associated_runtimes: Optional[list[AssociatedRuntimesForListMemoryCollections]] = Field(default=None, alias="AssociatedRuntimes")
    ...
    name: Optional[str] = Field(default=None, alias="Name")
    network_configuration: Optional[NetworkConfigurationForListMemoryCollections] = Field(default=None, alias="NetworkConfiguration")
    ...
    tags: Optional[list[TagsForListMemoryCollections]] = Field(default=None, alias="Tags")
...
class LongTermForUpdateMemoryCollection(MemoryBaseModel):
    strategies: Optional[list[LongTermStrategiesItemForUpdateMemoryCollection]] = Field(default=None, alias="Strategies")
...
class UpdateMemoryCollectionRequest(MemoryBaseModel):
    ...
    vpc_config: Optional[VpcForUpdateMemoryCollection] = Field(default=None, alias="VpcConfig")
...
class ListMemoryCollectionsRequest(MemoryBaseModel):
    ...
    filters: Optional[list[FiltersItemForListMemoryCollections]] = Field(default=None, alias="Filters")
    tag_filters: Optional[list[TagFiltersItemForListMemoryCollections]] = Field(default=None, alias="TagFilters")
...
class AddMemoryCollectionRequest(MemoryBaseModel):
    collections: Optional[list[CollectionsItemForAddMemoryCollection]] = Field(default=None, alias="Collections")
...
class GetMemoryCollectionResponse(MemoryBaseModel):
    associated_runtimes: Optional[list[AssociatedRuntimesForGetMemoryCollection]] = Field(default=None, alias="AssociatedRuntimes")
    create_time: Optional[str] = Field(default=None, alias="CreateTime")
    description: Optional[str] = Field(default=None, alias="Description")
    last_update_time: Optional[str] = Field(default=None, alias="LastUpdateTime")
    ...
    vpc_config: Optional[VpcConfigForGetMemoryCollection] = Field(default=None, alias="VpcConfig")


# CreateMemoryCollection - Request
class LongTermForCreateMemoryCollection(MemoryBaseModel):
    strategies: Optional[list[LongTermStrategiesItemForCreateMemoryCollection]] = Field(default=None, alias="Strategies")
...
class CreateMemoryCollectionRequest(MemoryBaseModel):
    ...
    project_name: Optional[str] = Field(default=None, alias="ProjectName")
    provider_type: Optional[str] = Field(default=None, alias="ProviderType")
    tags: Optional[list[TagsItemForCreateMemoryCollection]] = Field(default=None, alias="Tags")
    vpc_config: Optional[VpcForCreateMemoryCollection] = Field(default=None, alias="VpcConfig")
