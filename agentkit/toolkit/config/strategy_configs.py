...
class LocalDockerConfig(AutoSerializableMixin):
    ...
    invoke_port: int = field(default=8000, metadata={"description": "Port for agent application invocation", "icon": "🌐"})

    # System internal fields (not visible to users during configuration)
    container_name: str = field(default="", metadata={"system": True, "description": "Container name, auto-generated from agent name if empty"})
    ports: List[str] = field(default_factory=lambda: ["8000:8000"], metadata={"system": True, "description": "Port mappings in host:container format"})
    volumes: List[str] = field(default_factory=list, metadata={"system": True, "description": "Volume mappings in host:container format"})
    restart_policy: str = field(default="unless-stopped", metadata={"system": True, "description": "Container restart policy"})
    memory_limit: str = field(default="1g", metadata={"system": True, "description": "Container memory limit"})
    cpu_limit: str = field(default="1", metadata={"system": True, "description": "Container CPU limit"})
    container_id: str = field(default="", metadata={"system": True, "description": "Container ID after deployment"})
    image_id: str = field(default="", metadata={"system": True, "description": "Docker image ID"})
    build_timestamp: str = field(default="", metadata={"system": True, "description": "Timestamp of image build"})
    deploy_timestamp: str = field(default="", metadata={"system": True, "description": "Timestamp of container deployment"})
    full_image_name: str = field(default="", metadata={"system": True, "description": "Full Docker image name with registry"})
...
class HybridVeAgentkitConfig(AutoSerializableMixin):
    ...
    runtime_id: str = field(default="", metadata={"system": True, "description": "Runtime instance ID", "aliases": ["ve_runtime_id"]})
    runtime_name: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "AgentKit Runtime instance name", "icon": "⚙️", "aliases": ["ve_runtime_name"]})
    runtime_role_name: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "Runtime authorization role name", "icon": "🔐", "aliases": ["ve_runtime_role_name"]})
    runtime_apikey_name: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "Runtime API key secret name", "aliases": ["ve_runtime_apikey_name"]})
    runtime_apikey: str = field(default="", metadata={"system": True, "description": "Runtime API key", "aliases": ["ve_runtime_apikey"]})
    runtime_endpoint: str = field(default="", metadata={"system": True, "description": "Runtime application access endpoint", "aliases": ["ve_runtime_endpoint"]})
    runtime_envs: Dict[str, str] = field(
        default_factory=dict, 
        metadata={
            "system": True,
...
class VeAgentkitConfig(AutoSerializableMixin):
    ...
    cp_workspace_name: str = field(default=DEFAULT_WORKSPACE_NAME, metadata={"system": True, "description": "Code Pipeline workspace name"})
    cp_pipeline_name: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "Code Pipeline pipeline name"})
    cp_pipeline_id: str = field(default="", metadata={"system": True, "description": "Code Pipeline pipeline ID"})

    # Runtime configuration for deployed application
    runtime_id: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "Runtime instance ID", "aliases": ["ve_runtime_id"]})
    runtime_name: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "Runtime instance name", "aliases": ["ve_runtime_name"]})
    runtime_role_name: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "Runtime authorization role name", "aliases": ["ve_runtime_role_name"]})
    runtime_apikey_name: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "Runtime API key secret name", "aliases": ["ve_runtime_apikey_name"]})
    runtime_apikey: str = field(default=AUTO_CREATE_VE, metadata={"system": True, "description": "Runtime API key for authentication", "aliases": ["ve_runtime_apikey"]})
    runtime_endpoint: str = field(default="", metadata={"system": True, "description": "Runtime application access endpoint (auto-populated after deployment)", "aliases": ["ve_runtime_endpoint"]})
    runtime_envs: Dict[str, str] = field(
        default_factory=dict, 
        metadata={
            "system": True,
    ...
    # Deployment metadata
    build_timestamp: str = field(default="", metadata={"system": True, "description": "Timestamp of image build"})
    deploy_timestamp: str = field(default="", metadata={"system": True, "description": "Timestamp of deployment"})
