...
class AgentkitConfigManager:
    ...
    def _resolve_project_dir(self) -> Path:
        ...
        if self.config_path.is_file():
            ...
            return self.config_path.parent if self.config_path.parent.exists() else Path.cwd()
    ...
    def update_strategy_config(self, strategy_name: str, config: Dict[str, Any], filter_empty: bool = True):
    ...
    def _reorder_by_dataclass_fields(self, strategy_name: str, config: Dict[str, Any]) -> Dict[str, Any]:
