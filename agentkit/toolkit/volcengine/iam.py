...
class UserInfo(BaseModel):
    ...
    mobile_phone_is_verified: Optional[bool] = Field(None, alias="MobilePhoneIsVerified")
    model_config = {
...
class VeIAM(BaseIAMClient):
    ...
    def create_role(self, role_name: str, trust_policy_document: str) -> Optional[CreateRoleResponse]:
        """Create role"""
    ...
    def ensure_role_for_agentkit(self, role_name: str) -> bool:
        ...
        agentkit_service_code = (os.getenv("VOLCENGINE_AGENTKIT_SERVICE") or os.getenv("VOLC_AGENTKIT_SERVICE") or "").strip().lower()
        service = 'vefaas'
