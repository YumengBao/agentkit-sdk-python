...
class NetworkConfigurationsForListMCPToolsets(MCPBaseModel):
    ...
    vpc_configuration: Optional[VpcConfigurationForListMCPToolsets] = Field(default=None, alias="VpcConfiguration")
...
class MCPToolsetsForListMCPToolsets(MCPBaseModel):
    ...
    created_at: Optional[str] = Field(default=None, alias="CreatedAt")
    mcp_services: Optional[list[MCPServicesForListMCPToolsets]] = Field(default=None, alias="MCPServices")
...
class NetworkConfigurationsForGetMCPToolset(MCPBaseModel):
    endpoint: Optional[str] = Field(default=None, alias="Endpoint")
    network_type: Optional[str] = Field(default=None, alias="NetworkType")
    vpc_configuration: Optional[VpcConfigurationForGetMCPToolset] = Field(default=None, alias="VpcConfiguration")
...
class MCPToolsetForGetMCPToolset(MCPBaseModel):
    associated_runtimes: Optional[list[AssociatedRuntimesForGetMCPToolset]] = Field(default=None, alias="AssociatedRuntimes")
    ...
    created_at: Optional[str] = Field(default=None, alias="CreatedAt")
    mcp_services: Optional[list[MCPServicesForGetMCPToolset]] = Field(default=None, alias="MCPServices")
    mcp_toolset_id: Optional[str] = Field(default=None, alias="MCPToolsetId")
    name: Optional[str] = Field(default=None, alias="Name")
    network_configurations: Optional[list[NetworkConfigurationsForGetMCPToolset]] = Field(default=None, alias="NetworkConfigurations")
    path: Optional[str] = Field(default=None, alias="Path")
...
class NetworkConfigurationsForListMCPServices(MCPBaseModel):
    endpoint: Optional[str] = Field(default=None, alias="Endpoint")
    network_type: Optional[str] = Field(default=None, alias="NetworkType")
    vpc_configuration: Optional[VpcConfigurationForListMCPServices] = Field(default=None, alias="VpcConfiguration")
...
class PublicPackageForGetMCPService(MCPBaseModel):
    ...
    package_manager_type: Optional[str] = Field(default=None, alias="PackageManagerType")
...
class CustomMcpConfigurationForGetMCPService(MCPBaseModel):
    ...
    private_package: Optional[PrivatePackageForGetMCPService] = Field(default=None, alias="PrivatePackage")
    public_package: Optional[PublicPackageForGetMCPService] = Field(default=None, alias="PublicPackage")
...
class BackendConfigurationForGetMCPService(MCPBaseModel):
    ...
    custom_mcp_configuration: Optional[CustomMcpConfigurationForGetMCPService] = Field(default=None, alias="CustomMcpConfiguration")
...
class NetworkConfigurationsForGetMCPService(MCPBaseModel):
    endpoint: Optional[str] = Field(default=None, alias="Endpoint")
    network_type: Optional[str] = Field(default=None, alias="NetworkType")
    vpc_configuration: Optional[VpcConfigurationForGetMCPService] = Field(default=None, alias="VpcConfiguration")
...
class AuthorizerForUpdateMCPToolset(MCPBaseModel):
    authorizer: Optional[AuthorizerAuthorizerForUpdateMCPToolset] = Field(default=None, alias="Authorizer")
    authorizer_type: str = Field(..., alias="AuthorizerType")

class AuthorizerAuthorizerForUpdateMCPToolset(MCPBaseModel):
    key_auth: Optional[AuthorizerAuthorizerKeyAuthForUpdateMCPToolset] = Field(default=None, alias="KeyAuth")

class AuthorizerAuthorizerKeyAuthForUpdateMCPToolset(MCPBaseModel):
    api_keys: Optional[list[AuthorizerAuthorizerKeyAuthApiKeysItemForUpdateMCPToolset]] = Field(default=None, alias="ApiKeys")
    api_key_location: Optional[str] = Field(default=None, alias="ApiKeyLocation")
    parameter: Optional[str] = Field(default=None, alias="Parameter")
...
class UpdateMCPToolsetRequest(MCPBaseModel):
    ...
    authorizer_configuration: Optional[AuthorizerForUpdateMCPToolset] = Field(default=None, alias="AuthorizerConfiguration")
...
class BackendForCreateMCPService(MCPBaseModel):
    custom_configuration: Optional[BackendCustomForCreateMCPService] = Field(default=None, alias="CustomConfiguration")
    custom_mcp_configuration: Optional[BackendCustomMcpForCreateMCPService] = Field(default=None, alias="CustomMcpConfiguration")
    function_configuration: Optional[BackendFunctionForCreateMCPService] = Field(default=None, alias="FunctionConfiguration")
...
class BackendCustomMcpForCreateMCPService(MCPBaseModel):
    private_package: Optional[BackendCustomMcpPrivatePackageForCreateMCPService] = Field(default=None, alias="PrivatePackage")
    public_package: Optional[BackendCustomMcpPublicPackageForCreateMCPService] = Field(default=None, alias="PublicPackage")
    function_id: Optional[str] = Field(default=None, alias="FunctionId")
    function_name: Optional[str] = Field(default=None, alias="FunctionName")

class BackendCustomMcpPrivatePackageForCreateMCPService(MCPBaseModel):
    envs: Optional[list[BackendCustomMcpPrivatePackageEnvsItemForCreateMCPService]] = Field(default=None, alias="Envs")
    command: Optional[str] = Field(default=None, alias="Command")
    image_url: Optional[str] = Field(default=None, alias="ImageUrl")
...
class InboundAuthorizerForCreateMCPService(MCPBaseModel):
    authorizer: Optional[InboundAuthorizerAuthorizerForCreateMCPService] = Field(default=None, alias="Authorizer")
    authorizer_type: str = Field(..., alias="AuthorizerType")

class InboundAuthorizerAuthorizerForCreateMCPService(MCPBaseModel):
    custom_jwt_authorizer: Optional[InboundAuthorizerAuthorizerCustomJwtAuthorizerForCreateMCPService] = Field(default=None, alias="CustomJwtAuthorizer")
    key_auth: Optional[InboundAuthorizerAuthorizerKeyAuthForCreateMCPService] = Field(default=None, alias="KeyAuth")
...
class InboundAuthorizerAuthorizerKeyAuthForCreateMCPService(MCPBaseModel):
    api_keys: Optional[list[InboundAuthorizerAuthorizerKeyAuthApiKeysItemForCreateMCPService]] = Field(default=None, alias="ApiKeys")
    api_key_location: Optional[str] = Field(default=None, alias="ApiKeyLocation")
    parameter: Optional[str] = Field(default=None, alias="Parameter")

class NetworkForCreateMCPService(MCPBaseModel):
    vpc_configuration: Optional[NetworkVpcForCreateMCPService] = Field(default=None, alias="VpcConfiguration")
...
class OutboundAuthorizerForCreateMCPService(MCPBaseModel):
    authorizer: Optional[OutboundAuthorizerAuthorizerForCreateMCPService] = Field(default=None, alias="Authorizer")
    authorizer_type: str = Field(..., alias="AuthorizerType")

class OutboundAuthorizerAuthorizerForCreateMCPService(MCPBaseModel):
    key_auth: Optional[OutboundAuthorizerAuthorizerKeyAuthForCreateMCPService] = Field(default=None, alias="KeyAuth")

class OutboundAuthorizerAuthorizerKeyAuthForCreateMCPService(MCPBaseModel):
    api_keys: Optional[list[OutboundAuthorizerAuthorizerKeyAuthApiKeysItemForCreateMCPService]] = Field(default=None, alias="ApiKeys")
    api_key_location: Optional[str] = Field(default=None, alias="ApiKeyLocation")
    parameter: Optional[str] = Field(default=None, alias="Parameter")

class ProtocolForCreateMCPService(MCPBaseModel):
    http_api_configuration: Optional[ProtocolHttpApiForCreateMCPService] = Field(default=None, alias="HttpApiConfiguration")
...
class CreateMCPServiceRequest(MCPBaseModel):
    ...
    backend_configuration: Optional[BackendForCreateMCPService] = Field(default=None, alias="BackendConfiguration")
    inbound_authorizer_configuration: Optional[InboundAuthorizerForCreateMCPService] = Field(default=None, alias="InboundAuthorizerConfiguration")
    network_configuration: Optional[NetworkForCreateMCPService] = Field(default=None, alias="NetworkConfiguration")
    outbound_authorizer_configuration: Optional[OutboundAuthorizerForCreateMCPService] = Field(default=None, alias="OutboundAuthorizerConfiguration")
    protocol_configuration: Optional[ProtocolForCreateMCPService] = Field(default=None, alias="ProtocolConfiguration")
    tags: Optional[list[TagsItemForCreateMCPService]] = Field(default=None, alias="Tags")
...
class ListMCPToolsetsRequest(MCPBaseModel):
    ...
    project_name: Optional[str] = Field(default=None, alias="ProjectName")
    filters: Optional[list[FiltersItemForListMCPToolsets]] = Field(default=None, alias="Filters")
    tag_filters: Optional[list[TagFiltersItemForListMCPToolsets]] = Field(default=None, alias="TagFilters")
...
class ListMCPToolsResponse(MCPBaseModel):
    mcp_service_tools: Optional[list[MCPServiceToolsForListMCPTools]] = Field(default=None, alias="MCPServiceTools")


# CreateMCPToolset - Request
class AuthorizerForCreateMCPToolset(MCPBaseModel):
    authorizer: Optional[AuthorizerAuthorizerForCreateMCPToolset] = Field(default=None, alias="Authorizer")
    authorizer_type: str = Field(..., alias="AuthorizerType")

class AuthorizerAuthorizerForCreateMCPToolset(MCPBaseModel):
    custom_jwt_authorizer: Optional[AuthorizerAuthorizerCustomJwtAuthorizerForCreateMCPToolset] = Field(default=None, alias="CustomJwtAuthorizer")
    key_auth: Optional[AuthorizerAuthorizerKeyAuthForCreateMCPToolset] = Field(default=None, alias="KeyAuth")
...
class AuthorizerAuthorizerKeyAuthForCreateMCPToolset(MCPBaseModel):
    api_keys: Optional[list[AuthorizerAuthorizerKeyAuthApiKeysItemForCreateMCPToolset]] = Field(default=None, alias="ApiKeys")
    api_key_location: Optional[str] = Field(default=None, alias="ApiKeyLocation")
    parameter: Optional[str] = Field(default=None, alias="Parameter")

class NetworkForCreateMCPToolset(MCPBaseModel):
    vpc_configuration: Optional[NetworkVpcForCreateMCPToolset] = Field(default=None, alias="VpcConfiguration")
    enable_private_network: Optional[bool] = Field(default=None, alias="EnablePrivateNetwork")
    enable_public_network: Optional[bool] = Field(default=None, alias="EnablePublicNetwork")
...
class CreateMCPToolsetRequest(MCPBaseModel):
    ...
    path: str = Field(..., alias="Path")
    project_name: Optional[str] = Field(default=None, alias="ProjectName")
    authorizer_configuration: Optional[AuthorizerForCreateMCPToolset] = Field(default=None, alias="AuthorizerConfiguration")
    network_configuration: Optional[NetworkForCreateMCPToolset] = Field(default=None, alias="NetworkConfiguration")
    tags: Optional[list[TagsItemForCreateMCPToolset]] = Field(default=None, alias="Tags")
...
class GetMCPToolsetResponse(MCPBaseModel):
    mcp_toolset: Optional[MCPToolsetForGetMCPToolset] = Field(default=None, alias="MCPToolset")
...
class ListMCPServicesRequest(MCPBaseModel):
    ...
    page_size: Optional[int] = Field(default=None, alias="PageSize")
    project_name: Optional[str] = Field(default=None, alias="ProjectName")
    filters: Optional[list[FiltersItemForListMCPServices]] = Field(default=None, alias="Filters")
    tag_filters: Optional[list[TagFiltersItemForListMCPServices]] = Field(default=None, alias="TagFilters")
...
class BackendForUpdateMCPService(MCPBaseModel):
    custom_configuration: Optional[BackendCustomForUpdateMCPService] = Field(default=None, alias="CustomConfiguration")
    custom_mcp_configuration: Optional[BackendCustomMcpForUpdateMCPService] = Field(default=None, alias="CustomMcpConfiguration")
    function_configuration: Optional[BackendFunctionForUpdateMCPService] = Field(default=None, alias="FunctionConfiguration")
...
class BackendCustomMcpForUpdateMCPService(MCPBaseModel):
    private_package: Optional[BackendCustomMcpPrivatePackageForUpdateMCPService] = Field(default=None, alias="PrivatePackage")
    public_package: Optional[BackendCustomMcpPublicPackageForUpdateMCPService] = Field(default=None, alias="PublicPackage")
    function_id: Optional[str] = Field(default=None, alias="FunctionId")
    function_name: Optional[str] = Field(default=None, alias="FunctionName")

class BackendCustomMcpPrivatePackageForUpdateMCPService(MCPBaseModel):
    envs: Optional[list[BackendCustomMcpPrivatePackageEnvsItemForUpdateMCPService]] = Field(default=None, alias="Envs")
    command: Optional[str] = Field(default=None, alias="Command")
    image_url: Optional[str] = Field(default=None, alias="ImageUrl")
...
class InboundAuthorizerForUpdateMCPService(MCPBaseModel):
    authorizer: Optional[InboundAuthorizerAuthorizerForUpdateMCPService] = Field(default=None, alias="Authorizer")
    authorizer_type: str = Field(..., alias="AuthorizerType")

class InboundAuthorizerAuthorizerForUpdateMCPService(MCPBaseModel):
    key_auth: Optional[InboundAuthorizerAuthorizerKeyAuthForUpdateMCPService] = Field(default=None, alias="KeyAuth")

class InboundAuthorizerAuthorizerKeyAuthForUpdateMCPService(MCPBaseModel):
    api_keys: Optional[list[InboundAuthorizerAuthorizerKeyAuthApiKeysItemForUpdateMCPService]] = Field(default=None, alias="ApiKeys")
    api_key_location: Optional[str] = Field(default=None, alias="ApiKeyLocation")
    parameter: Optional[str] = Field(default=None, alias="Parameter")

class OutboundAuthorizerForUpdateMCPService(MCPBaseModel):
    authorizer: Optional[OutboundAuthorizerAuthorizerForUpdateMCPService] = Field(default=None, alias="Authorizer")
    authorizer_type: str = Field(..., alias="AuthorizerType")

class OutboundAuthorizerAuthorizerForUpdateMCPService(MCPBaseModel):
    key_auth: Optional[OutboundAuthorizerAuthorizerKeyAuthForUpdateMCPService] = Field(default=None, alias="KeyAuth")

class OutboundAuthorizerAuthorizerKeyAuthForUpdateMCPService(MCPBaseModel):
    api_keys: Optional[list[OutboundAuthorizerAuthorizerKeyAuthApiKeysItemForUpdateMCPService]] = Field(default=None, alias="ApiKeys")
    api_key_location: Optional[str] = Field(default=None, alias="ApiKeyLocation")
    parameter: Optional[str] = Field(default=None, alias="Parameter")
...
class UpdateMCPServiceRequest(MCPBaseModel):
    backend_type: Optional[str] = Field(default=None, alias="BackendType")
    mcp_service_id: str = Field(..., alias="MCPServiceId")
    backend_configuration: Optional[BackendForUpdateMCPService] = Field(default=None, alias="BackendConfiguration")
    inbound_authorizer_configuration: Optional[InboundAuthorizerForUpdateMCPService] = Field(default=None, alias="InboundAuthorizerConfiguration")
    outbound_authorizer_configuration: Optional[OutboundAuthorizerForUpdateMCPService] = Field(default=None, alias="OutboundAuthorizerConfiguration")
...
class GetMCPServiceResponse(MCPBaseModel):
    mcp_service: Optional[MCPServiceForGetMCPService] = Field(default=None, alias="MCPService")
