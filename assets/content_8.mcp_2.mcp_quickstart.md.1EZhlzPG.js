import{_ as a,c as n,o as i,ag as p}from"./chunks/framework.CA4hJK0u.js";const E=JSON.parse('{"title":"AgentKit MCP Quick Start","description":"","frontmatter":{},"headers":[],"relativePath":"content/8.mcp/2.mcp_quickstart.md","filePath":"content/8.mcp/2.mcp_quickstart.md","lastUpdated":1764227036000}'),e={name:"content/8.mcp/2.mcp_quickstart.md"};function l(t,s,h,k,r,c){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="agentkit-mcp-quick-start" tabindex="-1">AgentKit MCP Quick Start <a class="header-anchor" href="#agentkit-mcp-quick-start" aria-label="Permalink to &quot;AgentKit MCP Quick Start&quot;">​</a></h1><h2 id="环境要求" tabindex="-1">环境要求 <a class="header-anchor" href="#环境要求" aria-label="Permalink to &quot;环境要求&quot;">​</a></h2><p>开始前你需要准备：</p><ol><li><p>一个开通了 AgentKit 的火山账号的 AccessKey &amp; SecretKey</p><blockquote><p>Tips： 需要确保 AccessKey 有 AgentKitFullAccess 权限。</p></blockquote></li><li><p>MCP 服务（可以部署在 VeFaas 或公网可访问的位置）</p><ul><li>现存支持 MCP 的服务后端</li><li>现存的 HTTP 服务和服务的 Swagger 接口定义Json，具体可以参考<a href="https://swagger.io/" target="_blank" rel="noreferrer">Swagger</a></li></ul></li><li><p>Python 3.12+ installed</p></li><li><p>方舟APIKEY</p></li></ol><h2 id="第一步-配置本地环境" tabindex="-1">第一步：配置本地环境 <a class="header-anchor" href="#第一步-配置本地环境" aria-label="Permalink to &quot;第一步：配置本地环境&quot;">​</a></h2><blockquote><p>可以使用 <code>uv</code> 或者 <code>python3 -m venv</code> 进行虚拟环境管理，下文将以 <code>uv</code>做为示例</p><p><code>uv</code> 安装参考：<a href="https://docs.astral.sh/uv/getting-started/installation/" target="_blank" rel="noreferrer">uv install</a></p></blockquote><p>虚拟环境配置</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">mkdir</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> agentkit-mcp-quickstart</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">source</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> .venv/bin/active</span></span></code></pre></div><p>安装依赖</p><blockquote><p>可以通过 <code>--index</code> 指定源，加快安装速度</p></blockquote><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">uv</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> pip</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> veadk-python</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">uv</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> pip</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> google-</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">pip</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -U</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> agentkit-sdk-python</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --index-url</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://artifacts-cn-beijing.volces.com/repository/agentkit/simple/</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --extra-index-url</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://mirrors.tuna.tsinghua.edu.cn/pypi/web/simple</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --trusted-host</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> mirrors.tuna.tsinghua.edu.cn</span></span></code></pre></div><h2 id="第二步-创建-agentkit-mcp" tabindex="-1">第二步：创建 AgentKit MCP <a class="header-anchor" href="#第二步-创建-agentkit-mcp" aria-label="Permalink to &quot;第二步：创建 AgentKit MCP&quot;">​</a></h2><ol><li><p>登录火山引擎 <a href="https://console.volcengine.com/agentkit/region:agentkit+cn-beijing/gateway/mcpservice" target="_blank" rel="noreferrer">AgentKit 控制台</a>。</p></li><li><p>为准备好的后端 <a href="https://console.volcengine.com/agentkit/region:agentkit+cn-beijing/gateway/mcpservice/create" target="_blank" rel="noreferrer">创建 MCP 服务</a>。</p></li><li><p>获取到创建后的 MCP 服务 Endpoint 和 ApiKey。会看到以下类似的输出：</p></li></ol><blockquote><p><code>httpUrl</code>即为 MCP 服务的 Endpoint，<code>Authorization</code> 即为 ApiKey。</p></blockquote><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
